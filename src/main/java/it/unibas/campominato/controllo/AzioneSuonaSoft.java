...
@NomeSwing("Soft")
@DescrizioneSwing("Cambia la musica di sottofondo con Soft")
@MnemonicoSwing("S")
@AcceleratoreSwing("ctrl S")
@DisabilitataAllAvvio(false)
public class AzioneSuonaSoft extends AzionePingAstratta{
    ...
    public void esegui(EventObject object) throws PingException {
        ...
        Utilita.riproduciFileAudioContinuamente("soft.wav", clipAudio);
        this.modello.putBean(Controllo.MESSAGGIO_STATO, new MessaggioPing("Riproduco Soft"));
    }
}
