...
@NomeSwing("Livello Avanzato")
@DescrizioneSwing("Sceglie il livello avanzato")
@DisabilitataAllAvvio(false)
public class AzioneLivelloAvanzato extends AzionePingAstratta{
    ...
    public void esegui(EventObject object) throws PingException {
        ...
        Scacchiera scacchiera = new Scacchiera(16,30,99);
        modello.putBean("righeScacchiera", 16);
        modello.putBean("colonneScacchiera", 30);
        modello.putBean("mineScacchiera", 99);
        modello.putBean("livello", 2);
        long secondi = 0;
        ...
        this.modello.putBean(Controllo.MESSAGGIO_STATO, new MessaggioPing("Livello Avanzato Avviato"));
    }
